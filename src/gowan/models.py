...
class Piece(models.Model):
    ...
    exhibitionPiece = models.ForeignKey('Exhibition')
    # many to one
    # exhibitionPiece = models.ForeignKey(
    #     'Exhibition', related_name="piece_names")
...
class Documentation(models.Model):
    ...
    documentation_pieces = models.ManyToManyField(
        Piece, through="documentation_link_piece")
...
class HeathLineLookup(models.Model):
    ...
    heath_line_pieces = models.ManyToManyField(
        Piece, through="heath_line_link_piece")
...
class MaterialLookup(models.Model):
    ...
    material_pieces = models.ManyToManyField(
        Piece, through="material_link_piece")
...
class SetCollection(models.Model):
    ...
    set_collection_piece = models.ManyToManyField(
        Piece, through="setCollection_link_piece")
